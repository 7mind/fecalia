...
func renderFECBaselineDoc(results []fecPoint) string {
	...
	b.WriteString("|---|---|\n")
	b.WriteString(fmt.Sprintf("| Bandwidth cap (netem rate) | %d Mbit/s |\n", fecCapMbit))
