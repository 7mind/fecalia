...
func TestCongestionAndTUNAQMExposition(t *testing.T) {
	...
	src := fakeTUNAQMSource{
		fakeSource: fakeSource{paths: []PathSnapshot{{
			...
			Congestion: &congestion.Snapshot{
				...
				TargetChanges:               4,
				IngressServiceHeadroom:      0.85,
				IngressPressureRatio:        0.75,
				IngressPressure:             true,
				IngressHeadroomChanges:      2,
				Held:                        true,
			},
		}}},
		tunAQM: &TUNAQMSnapshot{
			...
			TargetHTBBurstBytes:       13_950,
			ActualHTBBurstBytes:       13_950,
			TargetTxQueueLen:          1110,
			ActualTxQueueLen:          1200,
			TargetDeviceTXQuota:       64,
			ActualDeviceTXQuota:       64,
			TargetEpoch:               7,
			ActualEpoch:               7,
			TargetQueueLimitBytes:     65_000,
			ActualQueueLimitBytes:     65_000,
			...
			ActualAdmissionLimitBytes: 20_000,
			RateFresh:                 true,
	...
	for _, want := range []string{
		...
		`wanbond_path_congestion_ingress_service_headroom_ratio{path="primary"} 0.85`,
		`wanbond_path_congestion_ingress_pressure_ratio{path="primary"} 0.75`,
		`wanbond_path_congestion_ingress_pressure{path="primary"} 1`,
		`wanbond_path_congestion_ingress_headroom_changes{path="primary"} 2`,
		...
		`wanbond_tun_aqm_target_htb_burst_bytes 13950`,
		`wanbond_tun_aqm_actual_htb_burst_bytes 13950`,
		`wanbond_tun_aqm_target_tx_queue_length 1110`,
		`wanbond_tun_aqm_actual_tx_queue_length 1200`,
		`wanbond_tun_aqm_target_device_tx_quota_packets 64`,
		`wanbond_tun_aqm_actual_device_tx_quota_packets 64`,
		`wanbond_tun_aqm_target_queue_limit_bytes 65000`,
		`wanbond_tun_aqm_actual_queue_limit_bytes 65000`,
		...
		`wanbond_tun_aqm_actual_engine_admission_limit_bytes 20000`,
		`wanbond_tun_aqm_actual_fresh 0`,
